...
class DetailsFragmentTest : BaseMainActivityTests() {

    @Inject lateinit var jsonUtil: JsonUtil
    @Inject lateinit var viewModelFactory: FakeMainViewModelFactory
    @Inject lateinit var requestManager: FakeGlideRequestManager
    @Inject lateinit var fragmentFactory: FakeMainFragmentFactory
